#!/usr/bin/env python3
"""
Generator preview statis — case study: Nanovest · US Stocks Limit Order.

Sepasang dengan komponennya di components/cases/NanovestLimitOrder.tsx.
...
Sini ("nanovest-limit-order") ada di siklus dua belas case: nanovest-calendar →
...
Jalankan:  python3 scripts/case_nanovest_limit_order.py [lang]
Sajikan :  python3 -m http.server 4321   →  /preview/nanovest-limit-order.html
"""
import json
import pathlib
import sys
