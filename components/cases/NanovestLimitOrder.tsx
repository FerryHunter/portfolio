...
/**
 * Case study: Nanovest · US Stocks Limit Order.
 *
 ...
 * scripts/case_nanovest_limit_order.py — dua file yang harus tetap
...
export default function NanovestLimitOrder({
  dict,
  lang,
  data,
}: CaseProps<Cases["nanovest-limit-order"]>) {
  const home = `/${lang}`;
